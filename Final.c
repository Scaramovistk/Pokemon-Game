...
{   
    ...
    do{
        ...
        {   
            ...
            delay(1);
            printf("\nWelcome to Kanto %s! Here we have diferent types of Pokemon!\n");
            ...
            switch(pokemonChoise){
                ...
                pPokmon.atk.mimAtk1 = 130;
                pPokmon.atk.mxAtk1 = 190;
            ...
            delay(1);
            printf("\nThere is a strange noise comming from that way\n");
            delay(1);
            ...
            char *newName, int *newHp, int *newXp, int *newLevel, int *newMimAtk1, int *newMxAtk1, int *newMimAtk2, int *newMxAtk2)
{
    ...
    *newXp = calculateXp(pPName, eMaxHp, xp);
    ...
    calculateEvolution(newLevel, newName, newHp, newMimAtk1, newMxAtk1, newMimAtk2, newMxAtk2,
